...
def fetch_poster(movie_id):
    url='https://api.themoviedb.org/3/movie/{}?api_key=cbf09296740c448f50be35d5ea4bdbb6&language=en+US'.format(movie_id)
    data=requests.get(url)
    data=data.json()
    poster_path=data['poster_path']
    full_path="http://image.tmdb.org/t/p/original/"+poster_path
    return full_path
